import AppUsersPage from './app.users.js'

class ApplicationsCreatePage extends AppUsersPage {
    ...
    get moreInfo() {return $('.align-self-center');}
...
// NEW INSTANCE !!!
export default new ApplicationsCreatePage();
